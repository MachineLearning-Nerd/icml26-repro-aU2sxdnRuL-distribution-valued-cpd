...
| [`orx/evaluator-blind-release-red-team`](https://github.com/MachineLearning-Nerd/icml26-repro-aU2sxdnRuL-distribution-valued-cpd/tree/orx/evaluator-blind-release-red-team) | Repeat canonical-entrypoint review after recorded red team | `uv sync --frozen && uv run --frozen python scripts/run_campaign.py` | PASS; 24 checks, 143 upload paths, blind traversal repeated | HF cpu-upgrade, no GPU, 15m53s |
| [`orx/final-publication-candidate`](https://github.com/MachineLearning-Nerd/icml26-repro-aU2sxdnRuL-distribution-valued-cpd/tree/orx/final-publication-candidate) | Embed completed review facts and execute final release gates | `uv sync --frozen && uv run --frozen python scripts/run_campaign.py` | Pending final clean run | HF cpu-upgrade, no GPU |
