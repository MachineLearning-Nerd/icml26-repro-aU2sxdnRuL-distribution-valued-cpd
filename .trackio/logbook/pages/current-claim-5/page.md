...
Limitation and unblock requirement: the exact paper-era 50+50 dated stream and private IDD/baseline configuration are unavailable. Publishing them would unblock the claim. Confidence remains LOW; all required three verification routes plus the mandatory falsification route—and additional routes—are complete.
